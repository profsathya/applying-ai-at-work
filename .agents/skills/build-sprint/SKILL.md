...
1. Establish the target course, sprint number or next unused sprint selection, and module context source from the request; clarify only missing or ambiguous information.
