...
- **Findings:** for verbosity revisions, include before/after body, prompt, and criteria measurements and concrete removed duplication/retained teaching; distinguish rendered observations from source counts. Record the source-conversion/adaptation mode and any participant testing actually observed. Also record resolved issues; intentionally deferred issues with reasons; consequential missing decisions for the human. Use "none found in this scope" rather than imply exhaustive certainty.
