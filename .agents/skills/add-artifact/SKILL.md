...
2. If course, sprint, or required grading details are ambiguous, ask one concise clarification before writing.
...
7. Push with `python3 canvas_sync/push.py --file <file> --manifest <manifest>`.
