...
## Follow-up: direct Canvas Welcome recheck

Verified at 2026-09-15T23:56:44.527048+00:00: a fresh browser visit to `https://cti-courses.instructure.com/courses/180/pages/welcome` displays the revised Welcome inside the existing Canvas iframe at the normal `?context=canvas` URL, with no cache-busting query. The pinboard illustration, direct opening, reading layout, updated headings, and integrated-document callout are present. A screenshot visually confirms the new illustration and layout. The stale iframe observed during deployment is no longer reproduced in this fresh visit. No further content or code change was required. The original content commit and publication report were already on main; this follow-up records the additional verification.
