---
type: assignment
title: Get underneath three to five
slug: get-underneath-three-to-five
artifact_id: course1-sprints-sprint-14-get-underneath-three-to-five
sprint: 14
week: 1
...
guided_assignment:
  version: '1.0'
  purpose: Describe three to five situations closely enough to identify a gap and
    who bears its cost.
  ...
  - id: your-table
    kind: response
    prompt: Your table, three to five rows, four columns each. Paste Part B of your
      Candidate Log, or a link to it.
    criteria:
    - Include three to five situations from your own list.
    - Describe actions in each current-state column rather than blame or fixes.
    - Name a person or role for each cost.
