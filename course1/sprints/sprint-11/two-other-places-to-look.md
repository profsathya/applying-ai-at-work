---
type: page
title: Two other places to look
...
Add any new indicators or surface requests to your working document. Next, use Candidate List to write three to five of them as gaps.
