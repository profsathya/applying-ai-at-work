...
1. **Identify affected, influential, and authority stakeholders.** Figure out who is affected by the problem, who can shape a solution, and who has the power to approve or block it.
2. **Use the Dojo to practice validation listening.** Practice your questions and think through what you might hear.
3. **Draft a stakeholder map with honest evidence status.** Lay out what you know for each stakeholder, and be clear about what's confirmed fact versus your own assumption.
4. **Conduct at least one real validation conversation.** Talk to an actual stakeholder and see whether your problem frame holds up.
5. **Revise your problem statement and Goal Plan based on what you learn.** Use what you heard to sharpen, adjust, or rebuild your frame.

## Sprint 3 Concepts

### Stakeholder

A stakeholder is not just a category like "users" or "management." In your problem context, a stakeholder is a specific person or role with a real relationship to *your* problem. It is someone whose life, work, or decisions actually touch it.
...
You will practice writing and testing your own validation questions in the Dojo Lab, and put them to a real person in the Stakeholder Conversation.
...
Take the **Sprint 3 Concept Check**, a short self-test quiz that confirms you have read and understood:

- The tasks that need to be done in Sprint 3.
- The concepts in Sprint 3.

Return to the **Sprint 3: Integrate People and Context** module home page to continue.
