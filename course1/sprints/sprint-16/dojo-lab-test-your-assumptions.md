...
guided_assignment:
  version: '1.0'
  purpose: Have AI push on your walk and your choice of check, then decide what to keep.
  builds_on: Bring your Assumptions walk and your check from the last activity, and your Problem
    Frame.
  ...
  - id: dojo-transcript
    ...
    - A final Me turn that states what was pushed on, what changed, what was kept with a reason,
      and the check as it now stands, still written before looking.
dojo_submission:
  mode: transcript
  prompt_version: v1
publish: false
