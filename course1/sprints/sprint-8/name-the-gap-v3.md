...
Gather what you do not know about your problem, in your own words, before any AI gets involved.

## Do this part without AI

If you ask an AI what someone working on your problem would need to learn, it will hand you a clean, sensible list. But it will be generic, not tailored to you. AI comes in at the Dojo Lab. Right now, the list has to be yours.

Use the **Learning Plan**, a document template you copy once and keep for the whole sprint. [Make your copy of the Learning Plan](https://docs.google.com/document/d/1XgCf1cTadZOCQtHdLEoebhJ8FWNjV6IzKUslKAtqxIA/copy). This week you fill in Part A and C1. You upload the same file again next week.
...
## A1. What you already understand well enough
...
Every blocking gap goes into your plan. Rank them. Ask: **which answer could change what the others mean?** That one goes first.
...
## A4. Why each one matters to your frame
...
Download your Learning Plan template as a PDF and upload it here. Part A and C1 should be complete: your gaps, sorted and ranked, with why each one matters, and your frame from Sprint 3 in C1. Part A usually runs 300 to 500 words.

Keep working in the same file. You will upload it again at the end of the sprint with Part B and C2 finished.

You are graded on the version you upload here. The Dojo Lab, later this week, will almost certainly change some of your gaps, and that is the point. Changing Part A afterwards does not affect this grade, and the Dojo Lab is where those changes get credited.

## Assessed on

- Every gap passes the sentence test: "Until I know this, I can't ___" can be filled from what you wrote.
- Each gap is sorted as blocking, useful, or interesting, and the blocking ones name the decision that is waiting.
- The blocking gaps are ranked, with a reason for what goes first.
- Each gap in the plan names the part of your Problem Frame that depends on it, and what a different answer would change.
- The interesting ones you left out each say what would make them matter.
- C1 holds your frame from Sprint 3 in all seven slots, with any slot you could not fill noted.
