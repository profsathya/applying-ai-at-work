...
guided_assignment:
  version: '1.0'
  purpose: Find the goal behind a requested solution and consider different problems that could
    stand in the way.
  ...
  - id: unpack-requests
    kind: response
    prompt: Your cumulative table (or what the search produced)
    criteria:
    - Goals describe what should change without prescribing a solution.
    - New rows come from observable possibilities considered alongside alternatives.
    - The cumulative table distinguishes current handling from the emerging gap and retains
      uncertainty.
    - An unchanged request or no new result is reported honestly; working notes need not be
      submitted.
    instruction_section: 3. Add observable possibilities
...
![A new colleague at a laptop and onboarding folder turns to a coworker arriving with a checklist.](assets/onboarding-help.webp)

*Getting started depends on people and handoffs. Illustration created with AI for this course.*

## 2. Find the goal, then consider obstacles
...
- An unowned handoff from HR to IT.
- Managers not knowing what work a new hire can take on.
- Training that covers tools but not the work itself.
...
## 3. Add observable possibilities
...
- **What bugs you:** the situation you can examine.
- **How it actually works now:** what happens and who does what.
- **The gap starting to show:** what falls short and who feels the cost. Mark uncertainty with **(?)**.
