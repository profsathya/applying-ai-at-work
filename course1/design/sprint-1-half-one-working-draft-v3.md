## Sprint 1, Half One: working draft (v3)

The whole move, from arriving with nothing to committing to one problem. Written as page prose. Section letters are scaffolding for us and get stripped before Canvas.
...
## B. Getting underneath

### B1. Moving from indicator to problem
...
Take whichever of your indicators you have the most to say about. Write two or three sentences on how it actually works today. Not how it feels. What happens, in what order, and who does what.

### B3. If the move stalls
...
### B4. One pass is usually not enough
...
### B5. If the move does nothing at all
...
[BREAK?] Natural pause. The reader has a list and has been under one item.

## C. Two other places to look

### C1. Things you stopped noticing
...
For the next day or two, notice the moments where you route around something. The step you always redo. The person you always have to chase. The file you keep a private copy of because the shared one is wrong. Add them to your list as they happen.
...
```mermaid
flowchart TD
  R["Surface request<br/>We need an app to track onboarding"]
  W1["Why?<br/>So managers can see who is stuck"]
  W2["Why does that matter?<br/>People wait days and nobody notices"]
  G["The goal<br/>New hires should be contributing<br/>as quickly as possible"]
  P1["Nobody owns<br/>the handoff"]
  P2["Managers cannot tell<br/>what to assign yet"]
  P3["Training covers tools,<br/>not the work"]
  F["Your choice<br/>which one you work on,<br/>and how you bound it"]
  R --> W1 --> W2 --> G
  G --> P1
  G --> P2
  G --> P3
...
[BREAK?] End of the teaching. Everything after this is doing. [OPEN] Concept check, if it lands here rather than at the D-to-E hinge.
...
### D2. If you are short, go looking
...
### D3. Write three to five of them as gaps
...
### D4. Mark what you are not sure about
...
## E. Find out which ones will survive

Submission 2 of 2 in this half, and it runs through the end of section F.

### E1. What the checks are for
...
### E2. Check 1. Are the people real and specific?
...
### E3. Check 2. Is something already handling it, and falling short?
...
### E4. Check 3. Is it live right now?
...
### E5. Check 4. Is it the right size?
...
### F2. Say why it, and why not the others
...
- The other-people nudge in A1. Keep it, or drop it and let D2 do the work.
- The Candidate Log: decided, not built. One collecting document started in A, filled through F, with D5 and F5 as snapshots of it. Template must ask for roughness. Builds in the activities pass.
- The no-AI rule for D: Leslie's review comment questions it. V3 keeps the narrow version pending her ruling.
- Concept check placement. After C3, or at the D-to-E hinge. E1 now teaches what the checks are for, which gives the hinge option something real to gate.
- Break points. Three marked. The strongest is after D5.
- Section C's two branches are unequal. C1 runs about 200 words, C2 about 1,000. Probably right, since requests need more machinery, but worth a look.
- The AI exchange in E8 depends on the unresolved Dojo and API key decision.
- Para 133 disagreement noted inline in C2. Yours to settle.
- 02 Introduction owed edits, now five: recast the four-check list to match E5; move Term 2 (problem frame) to half two; fix the Next section and Week 1 bullet, which point to the superseded concept page; rename "the noticing step" in Time Guidance to match section A's current name; rewrite "you own the goal, the standards, and the final judgment calls" toward Welcome V2's Human Value term, dropping "standards."
- Test edition for Melisa and Clare: this file, markers and scaffolding stripped, once Leslie reviews the new E.
