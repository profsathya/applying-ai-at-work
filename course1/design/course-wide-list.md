...
4b. **The transcript block's position.** The renderer places "Submit the complete transcript" (the final Me turn, the request, continue, paste) at the bottom of every transcript Dojo Lab. A page cannot put those steps under its own heading. Proposal for Jeremy: let a page name the section the block renders under, as instruction_section does for tasks. The phrase "final Me: turn" in that block is also worth plain words: the last message you send, which the transcript labels Me.
