...
One line before you leave: what does starting this table change about how you would describe your problem?
...
Your table as you started it, in a sentence or two, and what was a question rather than a thing.

### 2. What did AI add or answer, and what did you make of it?

For each thing it added or answered: kept, set aside, or not sure, with a reason. Setting nothing aside is fine if you say why nothing deserved it. This is the Choices step, made visible.

> **Example.** Kept: the CRM field exists and can notify a team; I did not know that, and it changes what a fix would cost. Set aside: account transition plans, because two accounts a month cannot carry that much process. Not sure: "a name for this kind of problem," which helped me search and told me nothing about my situation.
...
Three honest answers, and you may land between them. Nothing out there fits, so the problem stands as framed. Something fits, and getting it adopted here is the problem. Something fits and would simply solve it, so this may not be worth eight weeks, and your runner-up comes into view.
...
- **before** (response). Prompt: *What you thought existed before you asked, and what was a question.* Criteria: matches the table submitted in the previous activity; questions distinguished from things.
- **what-ai-added** (response). Prompt: *What AI added or answered; kept, set aside, or not sure, each with a reason.* Criteria: every AI contribution has a disposition and a reason; a disposition of "kept" says what it changes; setting nothing aside comes with a reason.
- **what-you-looked-at** (response). Prompt: *The two or three you looked at, with where you looked and what you learned.* Criteria: sources are outside the chat; what was learned is about how the thing works.
...
> **[BUILD]** `presentation: reading`, five boxes. Sections 1 to 5 feed before, what-ai-added, what-you-looked-at, does-it-change, how-you-describe-it in order. Points concentrate in the last two boxes; rubric to follow the team decision.
...
Everything in this sprint has been pointed at one question, and this is where you answer it. Four parts: a short Dojo step before you decide, the check as it came back, your Problem Frame brought up to date, and the verdict. The verdict is yours. It lives here, in your own words, and not in the frame, because it is this sprint's answer and the frame carries on.

### Part 1. Before you decide

One prompt in your Dojo, or any AI chat. Paste your Problem Frame, what came back from your check, and your table after the real look, then:
...
The check as you wrote it before you looked, and then: what you checked it against and when; what came back, as confirmed, contradicted, or complicated, with the "but" written down if there is one; and what you make of it, which is a separate thing from what came back. If the check could not be run, say what you tried and leave the assumption as "not yet." That is an honest outcome and it is graded as one.
