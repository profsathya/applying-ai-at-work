...
- **problem-frame** (response). Prompt: *Your Problem Frame, all seven parts, brought up to date: part 6 with its Status column filled, part 3c in, 4a if changed, the date at the top.* Criteria: all seven parts present, in the participant's words; every row of part 6 has an entry in its Status column; every risk rating carries a reason; part 3c is present and compares with 3b; at least one assumption is rated high risk and unconfirmed.
