...
- **what-a-change-would-ask** (response). Prompt: *What any change here would ask of the people in 3a, and who would have to agree: a short brainstorm, row by row, from your What already exists table.* Criteria: names at least one thing a change would ask of a person in 3a (a step, a habit, time, or a decision); names who would have to agree; draws on the rows of the table, not on a chosen solution.
