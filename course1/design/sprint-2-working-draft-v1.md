...
### 1. Test the walk and the choice

Paste your four boxes from the last page, then this:
...
2. **Multiple choice.** You decide not to check an assumption because the likely answer would not change what you do. In part 6 of your frame you write: (a) confirmed; (b) not yet; (c) accepted, because, and your reason; (d) nothing, and delete the line. *(c.)*
3. **Multiple choice.** Which of these is the best reason to choose an assumption to check in week 1? (a) It is the one you are most curious about. (b) Its answer could end the problem, and you can reach someone or something this week. (c) It is the first one on the list. (d) AI suggested it. *(b.)*
...
## Which assumptions, and your check
