...
**6. Your assumptions.** Everything in parts 2 to 5 that you wrote as if it were true without having seen it yourself or heard it from someone who would know. Each one confirmed or unverified, with who could tell you. *The Status column is filled in Sprint 2, week 2, and kept up from then on: high risk or low risk, with the reason, and anything you found out, in one line; Sprint 3 takes the high-risk ones to a real person, and Sprint 4 adds which gap will check the rest. Leave it blank until Sprint 2.*
