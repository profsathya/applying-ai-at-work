...
course1/design/sprint-2-outline.md                 Sprint 2, outline v5 (17 September), with Leslie for a ruling on structure
...
Sprint 2 is Leslie's. The outline is `sprint-2-outline.md`, v5 as of 17 September, on the
