...
```mermaid
flowchart TD
    A[Brainstorm your list<br/>wide, by area of life] --> B[Get underneath<br/>three to five, four columns]
    B --> C[First frames<br/>one per survivor, seven parts, claims audited]
    C --> D[Dojo Lab<br/>attack, widen, choose]
    D --> E[Goal Plan and Problem Frame<br/>the chosen one, frame v2, what changed]
    E --> F[Reflection]
    S[Sources, as help<br/>bugs you, stopped noticing, handed to you] -.-> A
    Q[Concept check] -.-> C
    E --> G[Sprint 2 receives the claims table]
```
